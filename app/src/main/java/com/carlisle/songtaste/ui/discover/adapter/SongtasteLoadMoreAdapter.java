 ...
 */
public abstract class SongtasteLoadMoreAdapter<T> extends BaseAdapter<T> implements LoadMoreInterface{
    ...
    protected SongtasteLoadMoreAdapter(Context context) {
