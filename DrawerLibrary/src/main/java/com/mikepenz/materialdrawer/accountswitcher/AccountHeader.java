...
public class AccountHeader {
    ...
    protected KenBurnsView mAccountHeaderBackground;
    ...
    public Result build() {
        ...
        mAccountHeaderBackground = (KenBurnsView) mAccountHeaderContainer.findViewById(R.id.account_header_drawer_background);
        // set the background
